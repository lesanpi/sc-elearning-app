...
import 'package:sc_elearning/widgets/course_list.dart';
import 'package:sc_elearning/widgets/guide_list.dart';
import 'package:sc_elearning/widgets/lesson_list.dart';

class HomeScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(child: homeScreen(context)),
    );
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.connectionState != ConnectionState.waiting) {
          ...
          lesson_list.shuffle();
          guide_list.shuffle();
          lesson_list = lesson_list.sublist(
              0, lesson_list.length < 5 ? lesson_list.length : 5);
          guide_list = guide_list.sublist(
              0, guide_list.length < 3 ? guide_list.length : 3);
        }
